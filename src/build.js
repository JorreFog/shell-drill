...
.term{box-shadow:0 0 0 1px rgba(35,48,65,.9), 0 18px 50px -32px rgba(63,185,80,.45)}
...
.pwrap::before{
  ...
  background-image:linear-gradient(rgba(35,48,65,.55) 1px,transparent 1px),
                   linear-gradient(90deg,rgba(35,48,65,.55) 1px,transparent 1px);
  background-size:44px 44px;
  mask-image:radial-gradient(760px 460px at 50% 20%,#000 30%,transparent 78%);
  -webkit-mask-image:radial-gradient(760px 460px at 50% 20%,#000 30%,transparent 78%);
}
